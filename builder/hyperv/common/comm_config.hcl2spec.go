...
// FlatCommConfig is an auto-generated flat version of CommConfig.
// Where the contents of a field with a `mapstructure:,squash` tag are bubbled up.
type FlatCommConfig struct {
...
// FlatMapstructure returns a new FlatCommConfig.
// FlatCommConfig is an auto-generated flat version of CommConfig.
// Where the contents a fields with a `mapstructure:,squash` tag are bubbled up.
func (*CommConfig) FlatMapstructure() interface{ HCL2Spec() map[string]hcldec.Spec } {
	return new(FlatCommConfig)
}

// HCL2Spec returns the hcl spec of a CommConfig.
// This spec is used by HCL to read the fields of CommConfig.
// The decoded values from this spec will then be applied to a FlatCommConfig.
func (*FlatCommConfig) HCL2Spec() map[string]hcldec.Spec {
